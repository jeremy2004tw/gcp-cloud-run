...
gcloud iam service-accounts create github-wif2 \
  --display-name="github-wif2"
...
for role in \
  ...
  gcloud projects add-iam-policy-binding $PROJECT_ID \
    --member="serviceAccount:github-wif2@$PROJECT_ID.iam.gserviceaccount.com" \
    --role="$role"
done

# Create binding between the service account and the workload identity provider:
gcloud iam service-accounts add-iam-policy-binding "github-wif2@$PROJECT_ID.iam.gserviceaccount.com" \
  --project="$PROJECT_ID" \
  --role="roles/iam.workloadIdentityUser" \
  --member="principalSet://iam.googleapis.com/projects/$PROJECT_NUMBER/locations/global/workloadIdentityPools/github-pool2/attribute.repository/jeremy2004tw/gcp-cloud-run"
...
# WIF_PROVIDER
# projects/79495184008/locations/global/workloadIdentityPools/github-pool2/providers/github-provider2

# SA_EMAIL
# github-wif2@terraform-demo-504200.iam.gserviceaccount.com
